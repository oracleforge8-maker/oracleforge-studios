...
@app.route('/api/birdeye/top')
def birdeye_top():
    import requests
    try:
        api_key = config.env("BIRDEYE_API_KEY")
        if not api_key:
            return jsonify(_mock_birdeye_data())
...
def _mock_birdeye_data():
    return [
        {"symbol": "BIRDEYE1", "name": "Birdeye Token 1", "price": 0.0045, "change_24h": 22.3, "volume_24h": 3200000, "url": "#"},
        {"symbol": "BIRDEYE2", "name": "Birdeye Token 2", "price": 0.0031, "change_24h": 16.8, "volume_24h": 2100000, "url": "#"},
        {"symbol": "BIRDEYE3", "name": "Birdeye Token 3", "price": 0.0018, "change_24h": 12.4, "volume_24h": 1500000, "url": "#"},
        {"symbol": "BIRDEYE4", "name": "Birdeye Token 4", "price": 0.0012, "change_24h": 9.7, "volume_24h": 1100000, "url": "#"},
        {"symbol": "BIRDEYE5", "name": "Birdeye Token 5", "price": 0.0009, "change_24h": 7.1, "volume_24h": 890000, "url": "#"},
        {"symbol": "BIRDEYE6", "name": "Birdeye Token 6", "price": 0.0006, "change_24h": 5.3, "volume_24h": 670000, "url": "#"},
        {"symbol": "BIRDEYE7", "name": "Birdeye Token 7", "price": 0.0004, "change_24h": 4.2, "volume_24h": 520000, "url": "#"},
        {"symbol": "BIRDEYE8", "name": "Birdeye Token 8", "price": 0.0003, "change_24h": 3.1, "volume_24h": 380000, "url": "#"},
        {"symbol": "BIRDEYE9", "name": "Birdeye Token 9", "price": 0.0002, "change_24h": 2.2, "volume_24h": 250000, "url": "#"},
